...
namespace Mindtree.WordProcessingAPI1.WordProcessor
{
        ...
        int[,] EncryptionMatrix = new int[15, 7]
    {
        ...
        /// <summary>
        /// This method is used to add the required document Protection for the given Document
        /// </summary>
        /// <param name="wdDocument"></param>
        /// <param name="strPassword"></param>
        public void ApplyDocumentProtection(WordprocessingDocument wdDocument, string strPassword)
        {
            // Generate the Salt
